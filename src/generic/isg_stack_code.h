...
inline ist_usize ISG_FN_NAME(pushm)(ISG_STRUCT_NAME* this, ISG_VALUE_TYPE _value) {
    isl_list_addmv(this->data, this->size, _value);
    return this->size - 1;
}
inline ist_usize ISG_FN_NAME(pushc)(ISG_STRUCT_NAME* this, ISG_VALUE_TYPE _value) {
...
ISG_VALUE_TYPE ISG_FN_NAME(pop)(ISG_STRUCT_NAME* this) {
    if (!this->size) isl_report(rid_stack_underflow);
