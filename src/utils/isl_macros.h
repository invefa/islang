...
#define __ISL_MACRO_CONCAT_WITH_UNDERLINE_IMPL(_x, _with, _y) _x##_with##_y

// Why do a wrapper for this macro? Because we need to wait the expanding of
// __ISL_MACRO_GET_ARGS_COUNT(...)
#define __ISL_MACRO_CONCAT_WITH(_x, _with, _y) __ISL_MACRO_CONCAT_WITH_UNDERLINE_IMPL(_x, _with, _y)
...
#define _isl_declare_initby_createby_with_consby(_paramspack, _type, _bywhat)    \
    _type* _type##_initby_##_bywhat(_type* this, _ISL_MACRO_UNPACK _paramspack); \
...
#define _isl_define_initby_createby_with_consby(_paramspack, _paramnamespack, _type, _bywhat)  \
    ...
    _type* _type##_createby_##_bywhat(_ISL_MACRO_UNPACK _paramspack) {                         \
        return _type##_initby_##_bywhat(isl_malloc(_type), _ISL_MACRO_UNPACK _paramnamespack); \
    }
